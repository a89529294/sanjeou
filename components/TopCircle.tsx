...
function TopCircle({
  ...
  return (
    <Link href={to}>
      <a
        className={`absolute flex flex-col items-center justify-center w-24 text-2xl text-white rounded-full hover:bg-hotter-than-hell aspect-square bg-primary-red ${className}`}
      >
